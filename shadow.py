...
===== #wHy =====
    **"""
        await event.reply(file='https://telegra.ph/file/fee99b3014a915857c66e.jpg', message=joker_313)
    elif event.pattern_match.group(1) == "فحص":
        hussein_ali = "**[+]  بوت النشر يعمل بنجاح✅ سيد wHy \n[+] في حال وجود مشكلة او استفسار تواصل معي\n t.me/iVOLT**"
        await event.reply(file='https://telegra.ph/file/fee99b3014a915857c66e.jpg', message=hussein_ali)
